...
def main(args: argparse.Namespace):
    ...
    # Set up datasets
    train_dataset = helper.BinaryLangDataset(train_df, key=lambda y: 0 if y == "" else 1, tokenizer=tokenizer, device=DEVICE)
    test_dataset = helper.BinaryLangDataset(test_df, key=lambda y: 0 if y == "" else 1, tokenizer=tokenizer, device=DEVICE)
